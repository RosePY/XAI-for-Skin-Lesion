...
CUDA_VISIBLE_DEVICES=4 python test_model_csv.py results-comet-iv4/iv4_isic2018_t3/checkpoints/model_best.pth ../isic-data/ISIC2018_Task3_Training_Input/ csv_splits/isic2018f_test.csv -n 50 -p -jpg -name isic2018t3 > results-comet-iv4/iv4_isic2018_t3/test_isic2018t3.txt	

CUDA_VISIBLE_DEVICES=4 python test_model.py results-comet-iv4/iv4_isic2018_t3/checkpoints/model_best.pth ../isic-data/edraAtlas/allimages/ ../isic-data/edraAtlas/EDRA_mel_benign.csv -n 50 -p -jpg -name edra_bin > results-comet-iv4/iv4_isic2018_t3/edra_bin.txt			
Metrics:
COMET INFO:     auc isic2018t3 : 0.9538250428816467			
"""
...
def main():
    #exp = ExistingExperiment(api_key="UUf811CMv6YQF3amngONvz02y",previous_experiment= '2511658629da4ef6aa33df0b089fcff7')
    exp = Comet_Exp(
    ...
    if args.jpg:
        train_ds = CSVDatasetWithName(
            os.path.join(args.dataset), os.path.join(args.csv), 'image_id', 'label',
