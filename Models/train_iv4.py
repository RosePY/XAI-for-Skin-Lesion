...
CUDA_VISIBLE_DEVICES=7 python train_iv4.py with train_root='../isic-data/HAM10000/ISIC2018_Task3_Training_Input/' train_csv='csv_splits/isic2018n_train.csv' epochs=100  val_root='../isic-data/HAM10000/ISIC2018_Task3_Training_Input/' val_csv='csv_splits/isic2018n_val.csv' model_name='inceptionv4' exp_name="iv4_nf_01"			
"""
