...
class ConceptDiscovery(object):
    ...
    def _random_concept_activations(self, bottleneck, random_concept):
        ...
        Args:
          ...
          random_concept: Name of the random concept e.g. "random_500_0"
    ...
    def _concept_cavs(self, bn, concept, activations, randoms=None, ow=True):
        ...
        if randoms is None:
            randoms = [
                'random_500_{}'.format(i) for i in np.arange(self.num_random_exp)
            ]
        if self.num_workers:
    ...
    def tcavs(self, test=False, sort=True, tcav_score_images=None):
        ...
        randoms = ['random_500_{}'.format(i) for i in np.arange(self.num_random_exp)]
    ...
    def find_profile(self, bn, images, mean=True):
        ...
        randoms = ['random_500_{}'.format(i) for i in range(self.num_random_exp)]
